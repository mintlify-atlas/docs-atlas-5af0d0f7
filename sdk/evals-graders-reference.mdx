---
title: "Graders and EvalSuite Reference"
sidebarTitle: "Graders Reference"
description: "Complete reference for EvalSuite, all built-in Grader classes, grader_plan(), GradeResult fields, and the Grader protocol for custom graders."
---
...
```python
EvalSuite(graders=None, *, plan="deterministic", metadata={})
```
