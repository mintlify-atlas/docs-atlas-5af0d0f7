---
title: "northstar.observe() — Instrument Functions as Child Spans"
sidebarTitle: "observe()"
description: "Use @northstar.observe() to wrap any function as a child span inside an active trace, capturing arguments as input and the return value as output."
---
