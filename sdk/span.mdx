---
title: "northstar.span() — Open a Child Span in an Active Trace"
sidebarTitle: "span()"
description: "Open a child span inside an active trace with northstar.span(). Use SpanKind to label spans as tool, model, agent, workflow, or custom steps."
---
