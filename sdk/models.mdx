...
sidebarTitle: "Models"
description: "Reference for core Pydantic models: Session, Run, Span, Event, Score, SpanKind, RunStatus, and CaptureOptions — all exported from the northstar package."
---
