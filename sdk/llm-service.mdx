...
description: "LLMService wraps LiteLLM and records MODEL spans, token usage, and USD cost automatically. Supports sync, async, streaming, and async streaming generation."
---
