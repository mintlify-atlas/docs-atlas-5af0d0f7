---
title: "northstar.trace() — Wrap Functions and Blocks as Trace Runs"
sidebarTitle: "trace()"
description: "Use northstar.trace() to create a top-level run. Works as a decorator or context manager, capturing inputs, outputs, latency, and exceptions automatically."
---
...
<ResponseField name="model_call(name, *, model)" type="method → context manager">
