---
title: "LLM Judges for Qualitative Agent Evaluation in NorthStar"
sidebarTitle: "LLM Judges"
description: "Grade agent responses with RubricJudge or FaithfulnessJudge. Set scoring mode, passing threshold, and judge model from any LiteLLM-compatible provider."
---
