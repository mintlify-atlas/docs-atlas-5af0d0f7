---
title: "NorthStar: AI Agent Observability Platform"
...
<CardGroup cols={2}>
  ...
  <Card title="Versioned Prompts" icon="file-lines">
    Store prompt templates server-side with `northstar.pull_prompt()`, compile them with Jinja or Python-style variables, and bind compiled versions directly to model call spans for full prompt lineage.
  </Card>
