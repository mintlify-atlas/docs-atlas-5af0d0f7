---
title: "Sessions, Runs, and the Low-Level Client"
sidebarTitle: "Sessions & Runs"
description: "Use the Northstar low-level client to manage sessions and runs directly, attach scores, and control capture options per run."
---
