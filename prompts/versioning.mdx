...
description: "Every prompt edit creates a new version with an incremented number and content hash. Labels like 'production' pin a named pointer to any version for safe rollout."
---
...
with northstar.pull_prompt("summarizer", label="staging", version=3) as prompt:
    compiled = prompt.compile(doc=doc_text, max_words=120)
    ...
```
